  ...
  useEffect(() => {
    ...
    for (let i = 0; i < links.length; i++) 
    {
      ...
      links[i].addEventListener('click', () => {
        ...
        if(links[i].classList.contains('dropdown-toggle')){ return; }
        else if(links[i].innerHTML.toLowerCase() === 'logout'){ return; }
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav px-2 ms-auto mb-2 mb-lg-0">
          ...
          <ul className="dropdown-menu">
            ...
            <li><Link className="dropdown-item" to='/'>TVs</Link></li>
            <li><Link className="dropdown-item" to='/'>Poeple</Link></li>
          </ul>
        </li>
        </ul>
